...
@ExtendWith(MockitoExtension.class) // Extensão do Mockito
public class BeerControllerTest {
    ...
    // Para testar as funcionalidades do Controller, que é a classe do projeto responsável
    // pela comunicação com a interface do usuário, utilizamos o 'mockMvc'.
    @BeforeEach
    void setUp() {
    ...
    // Teste da criação de uma Cerveja com sucesso.
    // 1- Construir o objeto DTO.
    // 2- Simula a criação do objeto Cerveja e retorna esse objeto.
    // 3- Com o mockMvc testar os métodos http (post) simulando uma
    //    interface que está chamando a api.
    @Test
    ...
    // Testando excessão: quando um campo obrigatório está vazio
    // 1- Construir o objeto DTO.
    // 2- Fazer com que a propriedade "Brand" seja nula.
    // 4- Simular a criação do objeto, via api.
    // 3- Validar se o retorno do teste é a excessão esperada.
    @Test
    ...
    void whenPATCHIsCalledToDecrementLowerThanZeroThenBadRequestStatusIsReturned() throws Exception {
        ...
        when(beerService.decrement(VALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerStockReachedMinimumException.class);
